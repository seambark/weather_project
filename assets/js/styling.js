...
currentbener.classList.add(`bg_${variousweather}`);
    ...
    //안개 이미지 관련
if (["fog", "haze","smoke","mist","dust","sand","volcanic ash","squalls","tornado"].includes(weather.weather[0].description)){
    currentbener.classList.remove("bg_few_clouds", "bg_scattered_clouds", "bg_broken_clouds", "bg_clear_sky", "bg_shower_rain", "bg_thunderstorm", "bg_rain", "bg_snow", "bg_mist", "bg_haze");
    ...
    weatherview = 
            ...
            //비 이미지 관련
}else if(["light rain", "moderate rain", "heavy intensity rain", "very heavy rain", "extreme rain"].includes(weather.weather[0].description)){
    currentbener.classList.remove("bg_few_clouds", "bg_scattered_clouds", "bg_broken_clouds", "bg_clear_sky", "bg_shower_rain", "bg_thunderstorm", "bg_rain", "bg_snow", "bg_mist", "bg_haze");
    ...
    weatherview = 
            ...
            //눈 이미지 관련
}else if(["sleet", "freezing","snow"].includes(weather.weather[0].description)){
    currentbener.classList.remove("bg_few_clouds", "bg_scattered_clouds", "bg_broken_clouds", "bg_clear_sky", "bg_shower_rain", "bg_thunderstorm", "bg_rain", "bg_snow", "bg_mist", "bg_haze");
